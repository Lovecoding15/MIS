...
BEGIN
    ...
    STATICTEXT 929, "Il CD-Rom contiene la versione corrente di BBj e Pro/5 per tutte piattaforme. Versioni precedenti sono scaricabile dal sito basis.cloud/products/downloads.html.", 10, 340, 270, 55
    BEGIN
...
WINDOW 119 "Selezionare rapporto" 0 0 350 310
BEGIN
    ...
    BUTTON 2, "&Cancella", 185, 275, 90, 25
    BEGIN
        NAME "Cancel"
    END
    ...
    RADIOBUTTON 106, "Rapporto account attempato", 25, 187, 300, 25
    BEGIN
        NAME "ar_rpt"
    END

    STATICTEXT 100, "Il rapporto \042Fatture arretrati\042 viene generato immediatamente nel suo browser", 41, 216, 289, 30
    BEGIN
        NAME "Static Text"
    END
