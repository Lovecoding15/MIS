...
WINDOW 101 "Rechnungsübersicht / Zahlungen" 0 0 790 500
BEGIN
    NOT CLOSEBOX
    ...
    NOTITLEBAR
    NOT SIZABLE
    STATICTEXT 125, "Fälligkeit", 300, 175, 70, 25
    BEGIN
        JUSTIFICATION 32768
        NAME "pmt_due_lbl"
    END
    ...
    BUTTON 250, "&Schließen", 680, 460, 90, 25
    BEGIN
        NAME "exit_btn"
    END
    ...
    STATICTEXT 585, "Ausgewählt", 532, 40, 100, 20
    BEGIN
        NAME "pmt_list_lbl"
    END

    BUTTON 200, "&Hinzufügen >", 407, 65, 90, 25
    BEGIN
        NAME "add"
    END
