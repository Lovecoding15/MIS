...
WINDOW 101 "Examiner/Payer Facture" 1 100 500 400
BEGIN
    NOT CLOSEBOX
    ...
    NAME "invoices"
    NOT SIZABLE
    STATICTEXT 125, "Date Echéance", 185, 95, 75, 20
    BEGIN
        NAME "pmt_due_lbl"
    END
    ...
    BUTTON 300, "&Envoyer", 235, 370, 80, 20
    BEGIN
        NAME "print_btn"
        SHORTCUE "Imprimer ou envoyer par email la facture sélectionné"
    END

    BUTTON 250, "Q&uitter", 375, 370, 80, 20
    BEGIN
        NAME "exit_btn"
    END
    ...
    STATICTEXT 550, "Factures", 175, 10, 45, 20
    BEGIN
    ...
    STATICTEXT 585, "Sélection", 330, 10, 61, 20
    BEGIN
        NAME "pmt_list_lbl"
    END

    BUTTON 200, "&Ajouter >", 260, 35, 60, 20
    BEGIN
        NAME "add"
    END

    BUTTON 220, "< &Retirer", 260, 55, 60, 20
    BEGIN
        NAME "remove"
    END

    STATICTEXT 115, "Balance", 10, 140, 50, 20
    BEGIN
        NAME "bal_due_lbl"
    END

    STATICTEXT 105, "Paiements", 10, 117, 60, 20
    BEGIN
        NAME "Pmts_lbl"
    END
    ...
    STATICTEXT 587, "Email copie PDF de cette facture à:", 15, 350, 202, 20
    BEGIN
        NAME "email_txt"
    END

    BUTTON 240, "&Effectuer", 375, 345, 80, 20
    BEGIN
        NAME "next"
        SHORTCUE "Payer le total / Appliquer le credit"
    END
    ...
    STATICTEXT 604, "Total Facture", 10, 95, 70, 20
    BEGIN
        NAME "inv_tot_lbl"
    END
    ...
    STATICTEXT 606, "Facture Départ", 10, 30, 80, 20
    BEGIN
        NAME "start_inv_lbl"
    END
    ...
    BUTTON 609, "&Afficher", 95, 55, 60, 20
    BEGIN
        NAME "display"
    END

    BUTTON 610, "Créditer facture", 185, 140, 100, 20
    BEGIN
        NAME "credit_btn"
    END
