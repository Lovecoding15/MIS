...
BEGIN
    ...
    STATICTEXT 929, "Vous trouverez sur le CD les versions actuelles de BBj et de PRO/5. Vous trouverez les versions d´auparavant à l´adresse suivante: basis.com/products/downloads.html", 15, 347, 275, 50
    BEGIN
...
WINDOW 119 "Sélectionnez un rapport" 0 0 350 250
BEGIN
    RADIOGROUP 104, 105
    NOT CLOSEBOX
    DIALOGBEHAVIOR
    ...
    BUTTON 2, "&Interruption", 185, 215, 90, 25
    BEGIN
        NAME "Cancel"
    END
    ...
    RADIOBUTTON 105, "Rapport de toutes les factures non-payées", 25, 127, 300, 25
    BEGIN
        NAME "ar_rpt"
    END

    STATICTEXT 100, "Le rapport chronologique des comptes débiteurs sera affiché dans votre explorer", 41, 156, 289, 30
    BEGIN
        NAME "Static Text"
    END
