...
BEGIN
    ...
    STATICTEXT 929, "CD contiene la versión actual de BBj y PRO/5 para todas las plataformas. Todas las versiones anteriores están disponibles en basis.cloud/products/downloads.html.", 15, 345, 270, 50
    BEGIN
...
WINDOW 119 "Seleccione Informe" 0 0 350 310
BEGIN
    ...
    BUTTON 2, "&Cancelar", 185, 275, 90, 25
    BEGIN
        NAME "Cancel"
    END
    ...
    RADIOBUTTON 106, "Reporte de Antiguedad de Saldos", 25, 187, 300, 25
    BEGIN
        NAME "ar_rpt"
    END

    STATICTEXT 100, "El Informe de Antigüedad de las Cuentas por Cobrar será visualizado inmediatamente en su navegador.", 41, 216, 289, 30
    BEGIN
        NAME "Static Text"
    END
